<%@ Page Title="" Language="C#" MasterPageFile="~/admin/ana.Master" AutoEventWireup="true" CodeBehind="kullaniciEkle.aspx.cs" Inherits="enesblog.admin.WebForm10" %>
            ...
            <div class="card card-light">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtKadi" runat="server" CssClass="form-control" placeholder="Banner Başlık Gir"></asp:TextBox>
                    </div>
                    <div class="form-group">
                        <label>Şifre</label>
                        <asp:TextBox ID="txtSifre" runat="server" CssClass="form-control" TextMode="Password" placeholder="Banner Başlık Gir"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <label>Şifre Tekrar</label>
                        <asp:TextBox ID="txtSifreTekrar" runat="server" CssClass="form-control" TextMode="Password" placeholder="Banner Başlık Gir"></asp:TextBox>
                    </div>
                    <div class="form-group">
